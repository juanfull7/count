...
<div id="menu">
        <ul class="menu">
            ...
            <li><a href="facturas.php"><img src="../img/iconta/ingresos icon.png">Ingresos</a>
                <ul class="submenu">
                    <li><a href="facturas.php">Facturas</a></li>
                    <li><a href="crearFactura.php">Nueva Factura</a></li>
                    <li><a href="crearFacturaRecu.php">Facturas recurrentes</a></li>
                    <li><a href="pagosRecibido.php">Pagos recibidos</a></li>
                    <li><a href="notasCredito.php">Notas de credito</a></li>
                    <li><a href="crearCotizacion.php">Cotizaciones</a></li>
