...
<div id="menu">
        <ul class="menu">
           ...
           <li><a href="index.php"><img src="../img/iconta/configuracion icon.png">Configuracion</a>
                
                <ul class="submenu">

                    <li><a href="index.php?facturacion=true">Facturacion</a></li>
                    <li><a href="index.php?plantillas=true">Plantillas</a></li>
                    <li><a href="index.php?impuestos=true">Impuestos</a></li>
                     <li><a href="index.php?empresa=true">Empresa</a></li>
                    <li><a href="index.php?notificaciones=true">Notificaciones y correos</a></li>
                    <li><a href="index.php?historial=true">Historial</a></li>
                     <li><a href="index.php?integracion=true">Integracion con apps</a></li>
                    <li><a href="index.php?suscripcion=true">Suscricion - planes</a></li>
