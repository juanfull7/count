...
<?php include('menuFreenetBancos.php');  ?>
<body>
      ...
      <article>
          ...
          <section class="contenido">
              <div class="actionbar-cont">
                  ...
                  <a href="crearFactura.php"> <div class="btn-nuevo"><img style="width:10% ; margin:0 7px; "src="../img/iconta/nueva factura 1 icon.png">Nuevo Banco</div></a>
              </div>
