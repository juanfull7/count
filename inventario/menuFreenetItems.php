...
<div id="menu">
        <ul class="menu">
           ...
           <li><a href="items.php"><img src="../img/iconta/inventario icon.png">Inventario</a>
                <ul class="submenu">
                    <li><a href="items.php">Items de venta</a></li>
                    <li><a href="valorInventario.php">Valor de Inventario</a></li>
                    <li><a href="ajusteInventario.php">Ajustes a Inventario</a></li>
                    <li><a href="gestionItems.php">Gestion de Items</a></li>
                    <li><a href="listaPrecios.php">Lista de Precios</a></li>
                    <li><a href="bodega.php">Bodegas</a></li>
