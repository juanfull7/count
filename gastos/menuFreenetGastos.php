...
<div id="menu">
        <ul class="menu">
           ...
           <li><a href="../ingresos/facturas.php"><img src="../img/iconta/ingresos icon.png">Ingresos</a>
            ...
            <li><a href="pagos.php"><img src="../img/iconta/gastos icon.png">Gastos</a>
                <ul class="submenu">
                    <li><a href="pagos.php">Pagos</a></li>
                    <li><a href="facturaProveedores.php">Facturas de Proveedores</a></li>
                    <li><a href="pagosRecurrentes.php">Pagos recurrentes</a></li>
                    <li><a href="notasDebito.php">Notas debito</a></li>
