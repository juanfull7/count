...
<div id="menu">
        <ul class="menu">
           ...
           <li><a href="../categorias/categorias.php"><img src="../img/iconta/categorias icon.png">Categorias</a>
            ...
            <li><a href="reportes.php"><img id="irepor" src="../img/iconta/reportes icon.png">Reportes</a>
               <ul class="submenu">
                    <li><a href="reportes.php?ventas=true">Ventas</a></li>
                    <li><a href="reportes.php?administrativos=true">Administrativos</a></li>
                    <li><a href="reportes.php?contables=true">Contables</a></li>
                    <li><a href="reportes.php?paraTrabajar=true">Para Trabajar</a></li>
